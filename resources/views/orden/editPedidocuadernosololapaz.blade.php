...
@section('content')
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('orden.cuaderno.sololapaz.update', $pedido->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <div class="col-md-6" id="campo_qr" style="display: none;">
        ...
        <input type="number" step="0.01" name="transferencia_qr" id="transferencia_qr" class="form-control"
            value="{{ old('transferencia_qr', $pedido->transferencia_qr ?? 0) }}">
                    ...
                    <a href="{{ route('envioscuaderno.sololapaz', $pedido->id_semana) }}" class="btn btn-secondary"><i
