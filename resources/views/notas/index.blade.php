    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-between">
                ...
                @can('roles.index')
                    <!-- Botón Agenda Jefa -->
                    <a href="{{ route('notasjefa.index') }}" class="btn btn-gradient-primary btn-lg">
        ...
        $(document).ready(function() {
            ...
            $('#guardarNota').click(function() {
                ...
                if (titulo && contenido && color) {
                    ...
                    $.ajax({
                        url: '{{ route('notas.store') }}', // Ruta definida en el archivo de rutas
                        type: 'POST',
                        data: {
                            titulo: titulo,
                            nota: contenido,
            ...
            $('#guardarCambiosNota').click(function() {
                ...
                if (titulo && contenido && color) {
                    ...
                    $.ajax({
                        url: '{{ route('notas.update', ':id') }}'.replace(':id',
            ...
            $('#eliminarNotaModal').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('notas.destroy', ':id') }}'.replace(':id',
            ...
            $('#imprimirNotaModal').click(function() {
                ...
                window.location.href = '{{ route('notas.imprimir', ':id') }}'.replace(':id', eventId);
            });
        });
    </script>
